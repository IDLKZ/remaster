...
Route::any('freedom-success', [App\Http\Controllers\FreedomController::class,"success"])->name("freedom-success");
Route::any('freedom-failure', [App\Http\Controllers\FreedomController::class,"failure"])->name("freedom-failure");
